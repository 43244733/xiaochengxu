...
<div class="am-g myapp-login">
    <div class="myapp-login-logo-block  tpl-login-max">
        <div class="myapp-login-logo-text">
            <div class="myapp-login-logo-text">
                <span> 商 家 注 册 </span> <i class="am-icon-skyatlas"></i>

            </div>
        </div>

        <div class="login-font">
           <a href="sellerLogin"><span>返 回 登 录</span></a>
        </div>

        <div class="am-u-sm-10 login-am-center">
            <form class="am-form" action="doInsertUser" , method="get">
                <fieldset>
                    <div class="am-form-group">
                        <input type="text" class="" id="doc-ipt-email-1" placeholder="注册您的账号" name="name">
                    </div>
                    <div class="am-form-group">
