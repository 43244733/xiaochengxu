        ...
        <div class="page-sidebar-wrapper" id="main-menu-wrapper">
            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="active" href="/selectAllArticle">浏览文章</a>
                        </li>
                        <li>
        ...
        <div class="wrapper main-wrapper row" style=''>
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    <div class="pull-left">
                        ...
                        <h1 class="title">远远围墙，隐隐茅堂。飏青旗、流水桥旁。</h1>
            ...
            <c:forEach items="${articleList}" var="article" varStatus="i">
                <c:if test="${i.count%10 == 1}">
                    <div class="col-xs-12 col-sm-6 col-lg-4 sort_panel">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">${article.title}</h2>
                                <div class="actions panel_actions pull-right">
                                    <a class="box_toggle fa fa-chevron-down"></a>
                                    <a class="box_setting fa fa-cog" data-toggle="modal" href="/updateArticle?id=${article.id}"></a>
                ...
                <c:if test="${i.count%10 == 4}">
                    <div class="col-xs-12 col-sm-6 col-lg-4 sort_panel">
                        <section class="box accent">
                            <header class="panel_header">
                                <h2 class="title pull-left">${article.title}</h2>
                                <div class="actions panel_actions pull-right">
                                    <a class="box_toggle fa fa-chevron-down"></a>
