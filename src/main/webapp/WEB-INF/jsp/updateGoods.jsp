        ...
        <div class="page-sidebar-wrapper" id="main-menu-wrapper">
            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="" href="charts-echart-line.html">商家管理</a>
                        </li>
                        <li>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="doUpdateGoods" method="get">
                                            <div class="col-xs-12">
                                                        ...
                                                        <c:forEach items="${shops}" var="shop">
                                                            <c:if test="${shop.id == updateId}">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" value="${shop.price}"
                                                                               name="price"/></td>
                                                                    <td class="hidden-480">
                                                                        <input type="text" value="${shop.type}"
                                                                               name="type"/>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" value="${shop.time}"
                                                                               name="time"/>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" value="${shop.number}"
                                                                               name="number"/>
                                                                    </td>
                                                                    <td>
