            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="active" href="updateArticle">修改文章</a>
                        </li>
                        <li>
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        ...
                        <h1 class="title">两水夹明镜，双桥落彩虹。人烟寒橘柚，秋色老梧桐。</h1>
                    ...
                    <div class="content-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                ...
                                <a class="btn btn-primary btn-block" href='mail-compose.html'>修改文章</a>
                            ...
                            <form action="doUpdateArticle" method="get">
                                ...
                                <div class="mail_content">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <h3 class="mail_head">Update Article</h3>
                                        ...
                                        <div class="col-xs-12 mail_view_info">
                                            ...
                                            <div class="form-group mail_cc_bcc">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control mail_compose_to" value="${article.title}" name="title"/>
                                            ...
                                            <div class="form-group mail_cc_bcc">
                                                ...
                                                <!-- <span class="desc">e.g. "someemail@example.com"</span> -->
                                                <div class="controls">
                                                    <input type="text" class="form-control mail_compose_to" value="${article.author}" name="author"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mail_cc_bcc">
                                                ...
                                                <!-- <span class="desc">e.g. "someemail@example.com"</span> -->
                                                <div class="controls">
                                                    <input type="text" class="form-control mail_compose_to" value="${article.brief}" name="brief"/>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label">内 容:</label>
                                                <textarea class="mail-compose-editor" placeholder="Enter text ..." style="width: 100%; height: 250px; font-size: 14px; line-height: 23px;padding:15px;" name="content">
                                                    ${article.content}
                                                </textarea>
                                            </div>
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class='pull-left'>
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="fa fa-paper-plane-o icon-xs"></i> &nbsp; 修改
                                                </button>
                                                <button type="button" class="btn btn-primary">
                                                    <i class="fa fa-floppy-o icon-xs"></i> &nbsp; 保存
                                                </button>
